  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-6 space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800">Menú Principal</h5>
            ...
            <div className="flex items-start space-x-3">
              <ClipboardList className="text-blue-500 mt-1" size={20} />
              <div>
                <h5 className="font-medium text-gray-800">Reportes</h5>
                <p className="text-gray-600">Genera reportes del inventario y stocks a formatos CSV y PDF</p>
              </div>
            </div>
        ...
        <section>
          <h4 className="text-xl font-semibold text-gray-800 mb-3">Reportes</h4>
          <div className="space-y-4">
            <div className="flex items-center space-x-3 text-gray-600">
              <ArrowDown className="text-green-500" size={20} />
              <span>Reportes de stock bajo</span>
            </div>
            <div className="flex items-center space-x-3 text-gray-600">
              <ArrowUp className="text-red-500" size={20} />
              <span>Reportes de Fechas de vencimiento</span>
            </div>
          </div>
        </section>
        ...
        {/* Modo Sin Conexión */}
        <section>
          <h4 className="text-xl font-semibold text-gray-800 mb-3">Sin Conexión</h4>
